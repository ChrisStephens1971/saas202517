...
1. Go to: `https://github.com/YOUR_ORG/saas202517/settings/secrets/actions`
...
# Check: https://github.com/YOUR_ORG/saas202517/actions
```

**Staging will be live at:** `https://saas202517-staging.azurecontainerapps.io`
...
**Production will be live at:** `https://saas202517.azurecontainerapps.io`

---

## Azure Resources Created

### Resource Group: `saas202517-rg`

All resources are organized in one resource group for easy management.

### Container Registry: `saas202517acr`

**Purpose:** Stores Docker images
**SKU:** Basic (upgradeable to Standard/Premium)
**URL:** `saas202517acr.azurecr.io`

### Container Apps Environment: `saas202517-env`
...
1. **saas202517-staging** (staging environment)
   - URL: `https://saas202517-staging.azurecontainerapps.io`
   - Min replicas: 1, Max replicas: 3
   - Auto-deploys on push to `develop` branch

2. **saas202517-prod** (production environment)
   - URL: `https://saas202517.azurecontainerapps.io`
   - Min replicas: 2, Max replicas: 10
   - Deploys on release tags only

### PostgreSQL Flexible Server: `saas202517-db`
...
**Databases:**
- `saas202517_staging` - Staging environment
- `saas202517_production` - Production environment

### Redis Cache: `saas202517-redis`
...
### Blob Storage: `saas202517storage`
...
az keyvault secret show \
  --vault-name saas202517-kv \
  --name DATABASE-URL-PRODUCTION \
  --query value -o tsv

# Connect with psql
psql "postgresql://username:password@saas202517-db.postgres.database.azure.com:5432/saas202517_production?sslmode=require"
```
...
2. Find your Container App: `saas202517-prod`
...
az containerapp logs show \
  --name saas202517-staging \
  --resource-group saas202517-rg \
  --follow

# Stream logs (production)
az containerapp logs show \
  --name saas202517-prod \
  --resource-group saas202517-rg \
  --follow
```
...
az monitor metrics alert create \
  ...
  --resource-group saas202517-rg \
  --scopes /subscriptions/{sub-id}/resourceGroups/saas202517-rg/providers/Microsoft.App/containerApps/saas202517-prod \
...
```
https://github.com/YOUR_ORG/saas202517/actions
```
...
az monitor metrics list \
  --resource /subscriptions/{sub-id}/resourceGroups/saas202517-rg/providers/Microsoft.App/containerApps/saas202517-prod \
...
az postgres flexible-server restore \
  --resource-group saas202517-rg \
  --name saas202517-db-restored \
  --source-server saas202517-db \
...
az containerapp revision activate \
  --name saas202517-prod \
  --resource-group saas202517-rg \
  --revision saas202517-prod--previous-revision
```
...
- **Project Repository**: https://github.com/ChrisStephens1971/saas202517
