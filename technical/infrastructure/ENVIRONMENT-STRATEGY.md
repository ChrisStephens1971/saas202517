...
| **URL** | localhost:3017 | staging.azurecontainerapps.io | azurecontainerapps.io |
...
DEBUG=true
DATABASE_URL=postgresql://localhost:5417/saas202517
REDIS_URL=redis://localhost:6417
FRONTEND_URL=http://localhost:3017
CORS_ORIGINS=http://localhost:3017
```
...
NODE_ENV=staging
DEBUG=true
DATABASE_URL=postgresql://saas202517-db.postgres.database.azure.com/saas202517_staging
REDIS_URL=rediss://saas202517-redis.redis.cache.windows.net:6380
FRONTEND_URL=https://saas202517-staging.azurecontainerapps.io
CORS_ORIGINS=https://saas202517-staging.azurecontainerapps.io
```
...
NODE_ENV=production
DEBUG=false
DATABASE_URL=postgresql://saas202517-db.postgres.database.azure.com/saas202517_production
REDIS_URL=rediss://saas202517-redis.redis.cache.windows.net:6380
FRONTEND_URL=https://saas202517.azurecontainerapps.io
CORS_ORIGINS=https://saas202517.azurecontainerapps.io,https://yourdomain.com
```
...
STAGING_URL=https://saas202517-staging.azurecontainerapps.io npm run test:e2e
```
