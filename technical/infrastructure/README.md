...
This directory contains all infrastructure, deployment, and operations documentation for saas202517.
...
- Add secrets to: `https://github.com/YOUR_ORG/saas202517/settings/secrets/actions`
...
|-------------|---------|-----|-------------|
| **Development** | Local machine | localhost:3017 | Manual |
| **Staging** | Testing/QA | saas202517-staging.azurecontainerapps.io | On push to `develop` |
| **Production** | Live users | saas202517.azurecontainerapps.io | On release tag |
